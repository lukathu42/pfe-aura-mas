...
**Audit date:** 2026-08-18 **Audited tree:** `~/Workspace/PFE(Memoire)/` (read-only; no project file was modified, moved, or deleted) **Auditor stance:** senior AI research scientist reviewing against current state-of-the-art standards for a Master's thesis in intelligent surveillance / agentic AI.
...
Layer 3 — Governance   : Streamlit operator console (aura\_mas/dashboard/app.py)
...
| :---- | :---- | :---- | :---- | :---- |
| abandoned\_object\_01 | **0.667** | 0.534 | 0.200 | 0.200 |
| audio\_alarm\_clock\_01 | **1.000** | **1.000** | **1.000** | **1.000** |
| audio\_alarm\_siren\_01 | 0.200 | 0.600 | **0.800** | **0.800** |
| audio\_glass\_break\_01 | 0.000 | **0.800** | **0.800** | **0.800** |
| combined\_audio\_video\_01 | **0.467** | 0.400 | 0.200 | 0.100 |
| demo\_site\_01 | 0.773 | **0.781** | 0.629 | 0.667 |
| fight\_01 | **1.000** | 0.800 | 0.400 | 0.200 |
| intrusion\_01 | **0.567** | 0.280 | 0.380 | 0.300 |
| loitering\_01 (true-negative probe) | 0.000 | 0.000 | 0.000 | 0.000 |
...
overlap \= task.get("fov\_overlap", {}).get(self.agent\_id, 0.5)
